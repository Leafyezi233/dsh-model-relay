 ...
 * scheduling knobs, nothing more. There are deliberately no conditions,
 * weights, or nested groups — a group is a list, and a list is a group.
 *
...
export class GatewayGroupStore {
   ...
   */
  async create(name, models, scheduling = {}) {
    ...
    await this.enqueue(async () => {
      ...
      const group = {
        ...
        models: candidates,
        enabled: true,
        strategy: normalizeStrategy(scheduling.strategy),
        retry429: normalizeRetry429(scheduling.retry429),
      }
